        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="container-fluid py-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h4 class="fw-bold mb-1">
                                        <i class="bi bi-send"></i> International Wire Transfer
                                    </h4>
                    ...
                    <!-- Transfer Form -->
                    <form action="{{ route('user.transfer.international') }}" method="POST">
                        @csrf
                            ...
                            <div class="card-body row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="beneficiary_name" value="{{ old('beneficiary_name') }}"
                                        ...
                                        placeholder="Enter beneficiary's full name" required>
                                </div>
                                <div class="col-md-6">
                                ...
                                <x-dashboard.user.form-select name="country" label="Country" type="select" class="col-md-6"
                                    value="{{ $user->country }}" :options="config('setting.countries')" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-0 small text-muted">International Bank Account Number</p>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" value="{{ old('description') }}"
                                        ...
                                        placeholder="Optional payment description or none"></textarea>
                                </div>
                                <div class="mb-3">
